...
definition Chart_A_A1 :: state where " Chart_A_A1 = State [''A'', ''A1'']
  ...
  (print1 ''Exit A1'' )
  []
  [Trans (P [''A'', ''A1'']) (S []) (Bc True) (SKIP) (SKIP) (J [''A'', ''5''])]
  (No_Composition)"
...
" g = (λ str. if str = [''A'', ''5''] then [Trans (J [''A'', ''5'']) (S []) (Bc True) (SKIP) (SKIP) (P [''A'', ''A1''])] else 
[])"
...
schematic_goal "Root_Exec_for_times env [''E'', ''E'', ''E'', ''E''] (4::int) s
 (Status (Vals ?v1 ?v2 ?v3 ?v4 ([''Entry A'', ''Entry A1'', ''During A'', ''Exit A1'', ''Entry A1'', ''During A'', ''Exit A1'', ''Entry A1'', ''Exit A1'', ''Exit A'', ''Entry B''], ?o2)) (?I))"
