...
_lr_productions = [
  ...
  ('statement -> statement ; statement','statement',3,'p_statement_list','parserAnnex.py',118),
  ('statement -> NAME ATTACHED expression','statement',3,'p_statement_assign','parserAnnex.py',130),
  ('statement -> expression','statement',1,'p_statement_expr','parserAnnex.py',134),
  ('expression -> expression PLUS expression','expression',3,'p_expression_binop','parserAnnex.py',138),
  ('expression -> expression MINUS expression','expression',3,'p_expression_binop','parserAnnex.py',139),
  ('expression -> expression TIMES expression','expression',3,'p_expression_binop','parserAnnex.py',140),
  ('expression -> expression DIVIDE expression','expression',3,'p_expression_binop','parserAnnex.py',141),
  ('expression -> expression REMAINDER expression','expression',3,'p_expression_binop','parserAnnex.py',142),
  ('expression -> expression EQUALS expression','expression',3,'p_expression_binop','parserAnnex.py',143),
  ('expression -> expression LEFT_ANGLE_BRA expression','expression',3,'p_expression_binop','parserAnnex.py',144),
  ('expression -> expression RIGHT_ANGLE_BRA expression','expression',3,'p_expression_binop','parserAnnex.py',145),
  ('expression -> expression COMP_OP expression','expression',3,'p_expression_binop','parserAnnex.py',146),
  ('statement -> expression !','statement',2,'p_expression_uminus','parserAnnex.py',174),
  ('expression -> ( expression )','expression',3,'p_expression_group','parserAnnex.py',178),
  ('expression -> NUMBER','expression',1,'p_expression_number','parserAnnex.py',182),
  ('expression -> NAME','expression',1,'p_expression_name','parserAnnex.py',185),
  ('expression -> expression , expression','expression',3,'p_expression_namelist','parserAnnex.py',189),
  ('type -> INT','type',1,'p_type_data','parserAnnex.py',202),
  ('type -> FLOAT','type',1,'p_type_data','parserAnnex.py',203),
  ('type -> BOOLEAN','type',1,'p_type_data','parserAnnex.py',204),
  ('statement -> VARIABLES expression : type','statement',4,'p_define_variable','parserAnnex.py',206),
  ('statement -> VARIABLES expression','statement',2,'p_define_variable','parserAnnex.py',207),
  ('state -> state state','state',2,'p_state_list','parserAnnex.py',216),
  ('state -> INITIAL','state',1,'p_state_list','parserAnnex.py',217),
  ('state -> COMPLETE','state',1,'p_state_list','parserAnnex.py',218),
  ('state -> FINAL','state',1,'p_state_list','parserAnnex.py',219),
  ('statement -> STATES NAME : state STATE','statement',5,'p_define_state','parserAnnex.py',226),
  ('statement -> TRANSITIONS NAME : NAME LEFT_DIS ON DISPATCH RIGHT_DIS NAME LEFT_CURLY_BRA statement RIGHT_CURLY_BRA','statement',12,'p_define_transtion','parserAnnex.py',230),
  ('statement -> IF ( expression ) statement END IF','statement',7,'p_if_statement','parserAnnex.py',234),
  ('statement -> WHILE ( expression ) statement END WHILE','statement',7,'p_while_statement','parserAnnex.py',238),
]
