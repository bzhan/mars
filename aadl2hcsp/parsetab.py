...
_lr_productions = [
  ...
  ('statement -> statement statement','statement',2,'p_statement_list','parserAnnex.py',146),
  ('statement -> NAME ATTACHED expression ;','statement',4,'p_statement_assign','parserAnnex.py',164),
  ('statement -> expression ;','statement',2,'p_statement_expr','parserAnnex.py',168),
  ('expression -> expression PLUS expression','expression',3,'p_expression_binop','parserAnnex.py',172),
  ('expression -> expression MINUS expression','expression',3,'p_expression_binop','parserAnnex.py',173),
  ('expression -> expression TIMES expression','expression',3,'p_expression_binop','parserAnnex.py',174),
  ('expression -> expression DIVIDE expression','expression',3,'p_expression_binop','parserAnnex.py',175),
  ('expression -> expression REMAINDER expression','expression',3,'p_expression_binop','parserAnnex.py',176),
  ('expression -> expression EQUALS expression','expression',3,'p_expression_binop','parserAnnex.py',177),
  ('expression -> expression LEFT_ANGLE_BRA expression','expression',3,'p_expression_binop','parserAnnex.py',178),
  ('expression -> expression RIGHT_ANGLE_BRA expression','expression',3,'p_expression_binop','parserAnnex.py',179),
  ('expression -> expression COMP_OP expression','expression',3,'p_expression_binop','parserAnnex.py',180),
  ('statement -> expression ! ;','statement',3,'p_expression_uminus','parserAnnex.py',208),
  ('expression -> ( expression )','expression',3,'p_expression_group','parserAnnex.py',212),
  ('expression -> NUMBER','expression',1,'p_expression_number','parserAnnex.py',216),
  ('expression -> NAME','expression',1,'p_expression_name','parserAnnex.py',219),
  ('expression -> expression , expression','expression',3,'p_expression_namelist','parserAnnex.py',223),
  ('type -> INT','type',1,'p_type_data','parserAnnex.py',236),
  ('type -> FLOAT','type',1,'p_type_data','parserAnnex.py',237),
  ('type -> BOOLEAN','type',1,'p_type_data','parserAnnex.py',238),
  ('statement -> VARIABLES expression : type ;','statement',5,'p_define_variable','parserAnnex.py',243),
  ('statement -> VARIABLES : expression ;','statement',4,'p_define_variable','parserAnnex.py',244),
  ('state -> state state','state',2,'p_state_list','parserAnnex.py',256),
  ('state -> INITIAL','state',1,'p_state_list','parserAnnex.py',257),
  ('state -> COMPLETE','state',1,'p_state_list','parserAnnex.py',258),
  ('state -> FINAL','state',1,'p_state_list','parserAnnex.py',259),
  ('statement -> STATES NAME : state STATE ;','statement',6,'p_define_state','parserAnnex.py',266),
  ('statement -> TRANSITIONS NAME : NAME LEFT_DIS ON DISPATCH RIGHT_DIS NAME LEFT_CURLY_BRA statement RIGHT_CURLY_BRA ;','statement',13,'p_define_transtion','parserAnnex.py',270),
  ('if_statement -> IF ( expression ) statement','if_statement',5,'p_if_substatement','parserAnnex.py',281),
  ('else_statement -> ELSE statement','else_statement',2,'p_else_substatement','parserAnnex.py',288),
  ('elif_statement -> ELIF ( expression ) statement','elif_statement',5,'p_elif_substatement','parserAnnex.py',295),
  ('elif_statement -> elif_statement elif_statement','elif_statement',2,'p_elif_substatement','parserAnnex.py',296),
  ('statement -> if_statement END IF ;','statement',4,'p_if_statement','parserAnnex.py',306),
  ('statement -> if_statement else_statement END IF ;','statement',5,'p_if_statement','parserAnnex.py',307),
  ('statement -> if_statement elif_statement else_statement END IF ;','statement',6,'p_if_statement','parserAnnex.py',308),
  ('statement -> WHILE ( expression ) statement END WHILE ;','statement',8,'p_while_statement','parserAnnex.py',317),
  ('statememt -> FOR ( expression IN expression RANGE expression ) LEFT_CURLY_BRA statement RIGHT_CURLY_BRA ;','statememt',12,'p_for_statement','parserAnnex.py',321),
]
