...
definition Chart_A_A1_A1a :: state where " Chart_A_A1_A1a = State [''A'', ''A1'', ''A1a'']
  ...
  (print1 ''Exit A1a'' )
  []
  [Trans (P [''A'', ''A1'', ''A1a'']) (S [''E_one'']) (Bc True) (send1 ''E_two'' False) (SKIP) (P [''A'', ''A1'', ''A1b''])]
  (No_Composition)"
...
" f_Chart_A_A1 = 
(λstr. if str = ''A1a'' then Chart_A_A1_A1a else 
...
schematic_goal "Root_Exec_for_times env [''E_one'', ''E_one''] (2::int) s
 (Status (Vals ?v1 ?v2 ?v3 ?v4 ([''Entry A'', ''Entry A1'', ''Entry A1a'', ''Entry A2'', ''Entry A2a'', ''During A'', ''During A1'', ''During A'', ''During A1'', ''During A1a'', ''During A2'', ''Exit A2a'', ''Entry A2b'', ''Exit A1a'', ''Entry A1b'', ''During A2'', ''During A2b''], ?o2)) (?I))"
