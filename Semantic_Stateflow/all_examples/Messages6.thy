...
definition Chart_A :: state where " Chart_A = State [''A'']
  (((((((((print1 ''en_A'' );''M1'' ::= N 4);send3 ''M1'' );''M'' ::= N 3);send3 ''M'' );''M1'' ::= N 3);send3 ''M1'' );''M1'' ::= N 2);send3 ''M1'' )
  (SKIP)
  (SKIP)
  []
...
definition Chart_B :: state where " Chart_B = State [''B'']
  ...
  (SKIP)
  []
  [Trans (P [''B'']) (M ''M1'') ((V ''M1'') [==] (N 3)) (SKIP) (SKIP) (P [''C''])]
  (No_Composition)"
...
definition Chart_C :: state where " Chart_C = State [''C'']
  ...
  (SKIP)
  []
  [Trans (P [''C'']) (M ''M1'') ((V ''M1'') [==] (N 2)) (SKIP) (SKIP) (P [''D''])]
  (No_Composition)"
...
definition Chart_D :: state where " Chart_D = State [''D'']
  ...
  (SKIP)
  []
  [Trans (P [''D'']) (S []) ((V ''M1'') [==] (N 2)) (SKIP) (SKIP) (P [''E''])]
  (No_Composition)"
...
schematic_goal "Root_Exec_for_times env ['''', ''''] (6::int) s
 (Status (Vals ?v1 ?v2 ?v3 ?v4 ([''en_A'', ''en_B'', ''en_C'', ''en_D'', ''en_E''], ?o2)) (?I))"
  unfolding Chart_A_def Chart_B_def Chart_C_def Chart_D_def Chart_E_def f_Chart_def 
