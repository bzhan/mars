...
void schedule_HPF(Thread **threads, int threadNum, Device **devices, int deviceNum, float stopTime) {
  ...
  fp_img = fopen("/Users/BEAR/Desktop/Simulink2C/Simulink2C/data/img.txt", "w");
  fp_proc_img = fopen("/Users/BEAR/Desktop/Simulink2C/Simulink2C/data/proc_img.txt", "w");
  fp_obs_pos_radar = fopen("/Users/BEAR/Desktop/Simulink2C/Simulink2C/data/obs_pos_radar.txt", "w");
  fp_obs_pos = fopen("/Users/BEAR/Desktop/Simulink2C/Simulink2C/data/obs_pos.txt", "w");
  fp_cmd = fopen("/Users/BEAR/Desktop/Simulink2C/Simulink2C/data/cmd.txt", "w");
  fp_veh_a = fopen("/Users/BEAR/Desktop/Simulink2C/Simulink2C/data/veh_a.txt", "w");
  fp_veh_s = fopen("/Users/BEAR/Desktop/Simulink2C/Simulink2C/data/veh_s.txt", "w");
  fp_veh_pos = fopen("/Users/BEAR/Desktop/Simulink2C/Simulink2C/data/veh_pos.txt", "w");
  fp_veh_v = fopen("/Users/BEAR/Desktop/Simulink2C/Simulink2C/data/veh_v.txt", "w");
  fp_des_a = fopen("/Users/BEAR/Desktop/Simulink2C/Simulink2C/data/des_a.txt", "w");
  fp_des_v = fopen("/Users/BEAR/Desktop/Simulink2C/Simulink2C/data/des_v.txt", "w");
  fp_veh_l_v = fopen("/Users/BEAR/Desktop/Simulink2C/Simulink2C/data/veh_l_v.txt", "w");
  fp_laser_valid = fopen("/Users/BEAR/Desktop/Simulink2C/Simulink2C/data/laser_valid.txt", "w");
  fp_laser_v = fopen("/Users/BEAR/Desktop/Simulink2C/Simulink2C/data/laser_v.txt", "w");
  fp_veh_w_v = fopen("/Users/BEAR/Desktop/Simulink2C/Simulink2C/data/veh_w_v.txt", "w");
  fp_wheel_valid = fopen("/Users/BEAR/Desktop/Simulink2C/Simulink2C/data/wheel_valid.txt", "w");
  fp_wheel_v = fopen("/Users/BEAR/Desktop/Simulink2C/Simulink2C/data/wheel_v.txt", "w");
