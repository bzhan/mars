...
_lr_productions = [
  ...
  ('statement -> statement ; statement','statement',3,'p_statement_list','parserAnnex.py',141),
  ('statement -> NAME ATTACHED expression','statement',3,'p_statement_assign','parserAnnex.py',153),
  ('statement -> expression','statement',1,'p_statement_expr','parserAnnex.py',157),
  ('expression -> expression PLUS expression','expression',3,'p_expression_binop','parserAnnex.py',161),
  ('expression -> expression MINUS expression','expression',3,'p_expression_binop','parserAnnex.py',162),
  ('expression -> expression TIMES expression','expression',3,'p_expression_binop','parserAnnex.py',163),
  ('expression -> expression DIVIDE expression','expression',3,'p_expression_binop','parserAnnex.py',164),
  ('expression -> expression REMAINDER expression','expression',3,'p_expression_binop','parserAnnex.py',165),
  ('expression -> expression EQUALS expression','expression',3,'p_expression_binop','parserAnnex.py',166),
  ('expression -> expression LEFT_ANGLE_BRA expression','expression',3,'p_expression_binop','parserAnnex.py',167),
  ('expression -> expression RIGHT_ANGLE_BRA expression','expression',3,'p_expression_binop','parserAnnex.py',168),
  ('expression -> expression COMP_OP expression','expression',3,'p_expression_binop','parserAnnex.py',169),
  ('statement -> expression !','statement',2,'p_expression_uminus','parserAnnex.py',197),
  ('expression -> ( expression )','expression',3,'p_expression_group','parserAnnex.py',201),
  ('expression -> NUMBER','expression',1,'p_expression_number','parserAnnex.py',205),
  ('expression -> NAME','expression',1,'p_expression_name','parserAnnex.py',208),
  ('expression -> expression , expression','expression',3,'p_expression_namelist','parserAnnex.py',212),
  ('type -> INT','type',1,'p_type_data','parserAnnex.py',225),
  ('type -> FLOAT','type',1,'p_type_data','parserAnnex.py',226),
  ('type -> BOOLEAN','type',1,'p_type_data','parserAnnex.py',227),
  ('statement -> VARIABLES expression : type','statement',4,'p_define_variable','parserAnnex.py',229),
  ('statement -> VARIABLES expression','statement',2,'p_define_variable','parserAnnex.py',230),
  ('state -> state state','state',2,'p_state_list','parserAnnex.py',239),
  ('state -> INITIAL','state',1,'p_state_list','parserAnnex.py',240),
  ('state -> COMPLETE','state',1,'p_state_list','parserAnnex.py',241),
  ('state -> FINAL','state',1,'p_state_list','parserAnnex.py',242),
  ('statement -> STATES NAME : state STATE','statement',5,'p_define_state','parserAnnex.py',249),
  ('statement -> TRANSITIONS NAME : NAME LEFT_DIS ON DISPATCH RIGHT_DIS NAME LEFT_CURLY_BRA statement RIGHT_CURLY_BRA','statement',12,'p_define_transtion','parserAnnex.py',253),
  ('statement -> IF ( expression ) statement END IF','statement',7,'p_if_statement','parserAnnex.py',257),
  ('statement -> WHILE ( expression ) statement END WHILE','statement',7,'p_while_statement','parserAnnex.py',261),
]
