...
_lr_productions = [
  ...
  ('statement -> statement ; statement','statement',3,'p_statement_list','parserAnnex.py',144),
  ('statement -> NAME ATTACHED expression','statement',3,'p_statement_assign','parserAnnex.py',156),
  ('statement -> expression','statement',1,'p_statement_expr','parserAnnex.py',160),
  ('expression -> expression PLUS expression','expression',3,'p_expression_binop','parserAnnex.py',164),
  ('expression -> expression MINUS expression','expression',3,'p_expression_binop','parserAnnex.py',165),
  ('expression -> expression TIMES expression','expression',3,'p_expression_binop','parserAnnex.py',166),
  ('expression -> expression DIVIDE expression','expression',3,'p_expression_binop','parserAnnex.py',167),
  ('expression -> expression REMAINDER expression','expression',3,'p_expression_binop','parserAnnex.py',168),
  ('expression -> expression EQUALS expression','expression',3,'p_expression_binop','parserAnnex.py',169),
  ('expression -> expression LEFT_ANGLE_BRA expression','expression',3,'p_expression_binop','parserAnnex.py',170),
  ('expression -> expression RIGHT_ANGLE_BRA expression','expression',3,'p_expression_binop','parserAnnex.py',171),
  ('expression -> expression COMP_OP expression','expression',3,'p_expression_binop','parserAnnex.py',172),
  ('statement -> expression !','statement',2,'p_expression_uminus','parserAnnex.py',200),
  ('expression -> ( expression )','expression',3,'p_expression_group','parserAnnex.py',204),
  ('expression -> NUMBER','expression',1,'p_expression_number','parserAnnex.py',208),
  ('expression -> NAME','expression',1,'p_expression_name','parserAnnex.py',211),
  ('expression -> expression , expression','expression',3,'p_expression_namelist','parserAnnex.py',215),
  ('type -> INT','type',1,'p_type_data','parserAnnex.py',228),
  ('type -> FLOAT','type',1,'p_type_data','parserAnnex.py',229),
  ('type -> BOOLEAN','type',1,'p_type_data','parserAnnex.py',230),
  ('statement -> VARIABLES expression : type','statement',4,'p_define_variable','parserAnnex.py',232),
  ('statement -> VARIABLES expression','statement',2,'p_define_variable','parserAnnex.py',233),
  ('state -> state state','state',2,'p_state_list','parserAnnex.py',242),
  ('state -> INITIAL','state',1,'p_state_list','parserAnnex.py',243),
  ('state -> COMPLETE','state',1,'p_state_list','parserAnnex.py',244),
  ('state -> FINAL','state',1,'p_state_list','parserAnnex.py',245),
  ('statement -> STATES NAME : state STATE','statement',5,'p_define_state','parserAnnex.py',252),
  ('statement -> TRANSITIONS NAME : NAME LEFT_DIS ON DISPATCH RIGHT_DIS NAME LEFT_CURLY_BRA statement RIGHT_CURLY_BRA','statement',12,'p_define_transtion','parserAnnex.py',256),
  ('statement -> IF ( expression ) statement END IF','statement',7,'p_if_statement','parserAnnex.py',261),
  ('statement -> WHILE ( expression ) statement END WHILE','statement',7,'p_while_statement','parserAnnex.py',265),
]
