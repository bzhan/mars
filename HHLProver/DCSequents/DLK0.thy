...
fun cutR_tac ctxt s i =
  Rule_Insts.res_inst_tac ctxt [((("P", 0), Position.none), s)] [] @{thm cut} i  THEN  resolve_tac ctxt [@{thm thinR}] i

(*Cut and thin, replacing the left-side formula*)
fun cutL_tac ctxt s i =
  Rule_Insts.res_inst_tac ctxt [((("P", 0), Position.none), s)] [] @{thm cut} i  THEN  resolve_tac ctxt [@{thm thinL}] (i+1)
*}
...
method_setup lem = {*
  Attrib.thm >> (fn th => fn ctxt =>
    SIMPLE_METHOD' (fn i =>
      ...
      REPEAT (resolve_tac ctxt [@{thm thinL}] i) THEN
