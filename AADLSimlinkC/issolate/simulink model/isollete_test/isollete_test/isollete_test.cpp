...
#include "conditioner_1.h"
	...
	*/
	...
	void rt_OneStep(THREAD *thread_Sensor, THREAD *thread_Regulator, THREAD *thread_HeatCooler)
	{
		...
		isolette_U.In1 = system_HeatRegulator(105, (int)isolette_Y.Out1, thread_Regulator, thread_HeatCooler, thread_Sensor);
...
int_T main(int_T argc, const char *argv[])
	{
		...
		*/
		...
		int count = 0;
		while ((count < 30) && (rtmGetErrorStatus(isolette_M) == (NULL)) && !rtmGetStopRequested
			(isolette_M)) {
