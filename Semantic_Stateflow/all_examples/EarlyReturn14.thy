...
definition Chart_A_A1 :: state where " Chart_A_A1 = State [''A'', ''A1'']
  ...
  (print1 ''ex_A1'' )
  []
  [Trans (P [''A'', ''A1'']) (S []) (Bc True) ((send1 ''E'' False); (print1 ''ca'' )) (print1 ''ta'' ) (P [''A'', ''A2''])]
  (No_Composition)"
...
schematic_goal "Root_Exec_for_times env ['''', ''''] (2::int) s
 (Status (Vals ?v1 ?v2 ?v3 ?v4 ([''en_A'', ''en_A1'', ''loop'', ''ex_A1'', ''ex_A'', ''en_A'', ''en_A1'', ''ca'', ''ex_A1'', ''ta'', ''en_A2''], ?o2)) (?I))"
