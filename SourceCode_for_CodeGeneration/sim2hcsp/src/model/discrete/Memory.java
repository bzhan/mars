...
public class Memory extends SL_Block {

	public Memory(String blockType, String blockName, Node node) {
		...
		for (Node n = node.getFirstChild(); n != null; n = n.getNextSibling()) {
			if (n.getNodeType() == Node.ELEMENT_NODE
					&& n.getAttributes().getNamedItem("Name") != null&& n.getAttributes().getNamedItem("Name").getNodeValue().equals("X0")) {
