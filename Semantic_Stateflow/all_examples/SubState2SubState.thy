...
definition Chart_A_A1 :: state where " Chart_A_A1 = State [''A'', ''A1'']
  ...
  (print1 ''exitA1'' )
  []
  [Trans (P [''A'', ''A1'']) (S [''E_one'']) (Bc True) (SKIP) (print1 ''transition_action'' ) (P [''B'', ''B1''])]
  (No_Composition)"
...
schematic_goal "Root_Exec_for_times env [''E_one'', ''E_one''] (2::int) s
 (Status (Vals ?v1 ?v2 ?v3 ?v4 ([''entryA'', ''entryA1'', ''duringA'', ''exitA1'', ''exitA'', ''transition_action'', ''entryB'', ''entryB1''], ?o2)) (?I))"
