...
{
if (true&&true&&Ch_plant_m1_1_1_w && !Ch_plant_m1_1_1_r)
{wait(2.0E-4,SC_SEC);
double currentX[3] = {plant_v1_1,plant_m1_1,plant_r1_1};
double arguments[3];
double phi[3];
...
plant_v1_1=plant_v1_1+phi[0]*2.0E-4;
plant_m1_1=plant_m1_1+phi[1]*2.0E-4;
plant_r1_1=plant_r1_1+phi[2]*2.0E-4;
wait(0,SC_SEC,Ch_plant_m1_1_1_w.posedge_event());
}
else 
break;
}
...
plant_v1_1=plant_v1_1+phi[0]*2.5262124836444855E-7;
plant_m1_1=plant_m1_1+phi[1]*2.5262124836444855E-7;
plant_r1_1=plant_r1_1+phi[2]*2.5262124836444855E-7;
wait(SC_ZERO_TIME);
}
if (!(true&&true)&&Ch_plant_m1_1_1_w && !Ch_plant_m1_1_1_r)
{Ch_plant_m1_1_1_w=0;
...
double plant_v1_1,plant_m1_1,plant_r1_1;
double *temp = new double[3];
plant_v1_1=arguments[0];plant_m1_1=arguments[1];plant_r1_1=arguments[2];
temp[0]=(control_1_0/plant_m1_1)-(1.622);temp[1]=-(control_1_0/(2548));temp[2]=plant_v1_1;
return temp;
}
...
double *temp = new double[3];
plant_v1_1=arguments[0];plant_m1_1=arguments[1];plant_r1_1=arguments[2];
temp[0]=(control_1_0/plant_m1_1)-(1.622);temp[1]=-(control_1_0/(2842));temp[2]=plant_v1_1;
return temp;
}
};
SC_MODULE(test) {
