...
public class CompareToZero extends SL_Block {

	public CompareToZero(String blockType, String blockName, Node node) {
...
//		ret.put("1b", "!(" + In1 + op + "0)");
	...
	public HashMap<String, String> semanticFunctionDiscrete() {
		...
		String ret1 = "(" + In1 + op + "0" + ") -> " + Out1 + ":=1";
		String ret2 = "(" + "!(" + In1 + op + "0)" + ") -> " + Out1 + ":=0";
