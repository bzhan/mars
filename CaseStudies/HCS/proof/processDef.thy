...
definition PC_Diff1 :: proc where
"PC_Diff1 == <(%''plant_v1_1, plant_m1_1, plant_r1_1, plant_t'',''(control_1/plant_m1_1) - 1.622, -(control_1/2548), plant_v1_1, 1''%) &&Inv1 && ((control_1[>](Real 3000)) [&] t [<] (Real 0.128))>: WTrue"
...
definition PC_Diff2 :: proc where
"PC_Diff2 == <(%''plant_v1_1, plant_m1_1, plant_r1_1, plant_t'',''(control_1/plant_m1_1) - 1.622, -(control_1/2842), plant_v1_1, 1''%) && Inv2 && ((control_1[<=](Real 3000)) [&] t [<] (Real 0.128))>: WTrue"
(*
...
definition PC_Diff :: proc where
"PC_Diff == (PC_Diff1);assertion33;(PC_Diff2)"
