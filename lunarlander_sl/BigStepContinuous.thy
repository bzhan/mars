  ...
  "Valid
    (\<lambda>s tr. (\<not>b s \<longrightarrow> Q s tr) \<and>
            (\<forall>d p. 0 < d \<longrightarrow> ODEsol ode p d \<longrightarrow> p 0 = s \<longrightarrow> (\<forall>t. 0 \<le> t \<and> t < d \<longrightarrow> b (p t)) \<longrightarrow> \<not>b (p d) \<longrightarrow>
                   Q (p d) (tr @ [WaitFBlock d (\<lambda>\<tau>. State (p \<tau>)) ({}, {})])))
    (Cont ode b)
    Q"
  unfolding Valid_def
  by (auto elim!: contE)
...
theorem Valid_interrupt:
  assumes "\<And>i. i < length cs \<Longrightarrow>
      ...
      (ch[!]e, p2) \<Rightarrow>
        (\<exists>Q. \<Turnstile> {Q} p2 {R} \<and>
             ...
             (P \<Longrightarrow>\<^sub>A (\<lambda>s tr. \<forall>d>0. \<forall>p. ODEsol ode p d \<longrightarrow> p 0 = s \<longrightarrow>
                        ...
                        Q (p d) (tr @ [WaitFBlock d (\<lambda>\<tau>. State (p \<tau>)) (rdy_of_echoice cs),
                                       OutBlock ch (e (p d))]))))
    | (ch[?]var, p2) \<Rightarrow>
        (\<exists>Q. \<Turnstile> {Q} p2 {R} \<and>
             ...
             (P \<Longrightarrow>\<^sub>A (\<lambda>s tr. \<forall>d>0. \<forall>p v. ODEsol ode p d \<longrightarrow> p 0 = s \<longrightarrow>
                        (\<forall>t. 0 \<le> t \<and> t < d \<longrightarrow> b (p t)) \<longrightarrow>
                        Q ((p d)(var := v)) (tr @ [WaitFBlock d (\<lambda>\<tau>. State (p \<tau>)) (rdy_of_echoice cs),
                                                   InBlock ch v]))))"
    ...
    and "P \<Longrightarrow>\<^sub>A (\<lambda>s tr. (\<forall>d>0. \<forall>p. ODEsol ode p d \<longrightarrow> p 0 = s \<longrightarrow>
                   ...
                   R (p d) (tr @ [WaitFBlock d (\<lambda>\<tau>. State (p \<tau>)) (rdy_of_echoice cs)])))"
...
proof -
  ...
  qed
  have b: "R s2 (tr1 @ WaitFBlock d (\<lambda>\<tau>. State (p \<tau>)) (rdy_of_echoice cs) # OutBlock ch (e (p d)) # tr2)"
    if *: "P (p 0) tr1"
          "0 < d"
          "ODEsol ode p d"
  ...
  proof -
    ...
    have "Q (p d) (tr1 @ [WaitFBlock d (\<lambda>\<tau>. State (p \<tau>)) (rdy_of_echoice cs),
                          OutBlock ch (e (p d))])"
  ...
  proof -
    ...
    then show ?thesis
      using *(4) 1(1) unfolding Valid_def by fastforce
  qed
  have d: "R s2 (tr1 @ WaitFBlock d (\<lambda>\<tau>. State (p \<tau>)) (rdy_of_echoice cs) # InBlock ch v # tr2a)"
    if *: "P (p 0) tr1"
          "0 < d"
          "ODEsol ode p d"
          "\<forall>t. 0 \<le> t \<and> t < d \<longrightarrow> b (p t)"
    ...
    from assms obtain Q where 1:
      ...
      "P \<Longrightarrow>\<^sub>A (\<lambda>s tr. \<forall>d>0. \<forall>p v. ODEsol ode p d \<longrightarrow> p 0 = s \<longrightarrow>
                 ...
                 Q ((p d)(var := v)) (tr @ [WaitFBlock d (\<lambda>\<tau>. State (p \<tau>)) (rdy_of_echoice cs),
                                            InBlock ch v]))"
      using *(5,6) by fastforce
    have "Q ((p d)(var := v)) (tr1 @ [WaitFBlock d (\<lambda>\<tau>. State (p \<tau>)) (rdy_of_echoice cs), InBlock ch v])"
      using 1(2) *(1-4) unfolding entails_def by auto
    then show ?thesis
      using *(7) 1(1) unfolding Valid_def by fastforce
  qed
...
theorem Valid_interrupt_Out:
  ...
  shows "\<Turnstile>
    {\<lambda>s tr. (Q s (tr @ [OutBlock ch (e s)])) \<and>
            (\<forall>d>0. \<forall>p. ODEsol ode p d \<longrightarrow> p 0 = s \<longrightarrow>
                (\<forall>t. 0 \<le> t \<and> t < d \<longrightarrow> b (p t)) \<longrightarrow>
                Q (p d) (tr @ [WaitFBlock d (\<lambda>\<tau>. State (p \<tau>)) ({ch}, {}),
...
| "0 < d \<Longrightarrow> ODEsol ode p d \<Longrightarrow> p 0 = s \<Longrightarrow> (\<forall>t. 0 \<le> t \<and> t < d \<longrightarrow> b (p t)) \<Longrightarrow> \<not>b (p d) \<Longrightarrow>
     ODE\<^sub>t s ode b (p d) [WaitFBlock d (\<lambda>\<tau>. State (p \<tau>)) ({}, {})]"
...
| "0 < d \<Longrightarrow> ODEsol ode p d \<Longrightarrow> p 0 = s \<Longrightarrow>
    ...
    ODEin\<^sub>t s ode b ((p d)(var := v)) ch var rdy
      [WaitFBlock d (\<lambda>\<tau>. State (p \<tau>)) rdy, InBlock ch v]"
...
| "0 < d \<Longrightarrow> ODEsol ode p d \<Longrightarrow> p 0 = s \<Longrightarrow>
    ...
    ODEout\<^sub>t s ode b (p d) ch e rdy
      [WaitFBlock d (\<lambda>\<tau>. State (p \<tau>)) rdy, OutBlock ch (e (p d))]"
...
| "0 < d \<Longrightarrow> ODEsol ode p d \<Longrightarrow> p 0 = s \<Longrightarrow>
    ...
    ODErdy\<^sub>t s ode b (p d) rdy
      [WaitFBlock d (\<lambda>\<tau>. State (p \<tau>)) rdy]"
...
proof -
  ...
  qed
  have 2: "Q (p d) (tr @ [WaitFBlock d (\<lambda>\<tau>. State (p \<tau>)) ({}, {})])"
  ...
  proof -
    have "(ODE\<^sub>t (p 0) ode b (p d) @- Q (p d)) tr"
      using that(1) by auto
    moreover have "ODE\<^sub>t (p 0) ode b (p d) [WaitFBlock d (\<lambda>\<tau>. State (p \<tau>)) ({}, {})]"
...
proof -
  ...
  have main: "d2 = d \<and> p d = p2 d2 \<and> (\<lambda>\<tau>\<in>{0..d}. State (p \<tau>)) = (\<lambda>\<tau>\<in>{0..d2}. State (p2 \<tau>)) \<and>
              WaitS\<^sub>t d p ({}, {}) [WaitFBlock d2 (\<lambda>\<tau>. State (p2 \<tau>)) ({}, {})]"
    if cond: "0 < d2"
       "ODEsol ode p2 d2"
  ...
  proof -
    ...
    have s11: "WaitS\<^sub>t d p ({}, {}) [WaitFBlock d2 (\<lambda>\<tau>. State (p2 \<tau>)) ({}, {})]"
...
proof -
           ...
           (P \<Longrightarrow>\<^sub>A
            (\<lambda>s tr.
                \<forall>d>0. \<forall>p. ODEsol ode p d \<longrightarrow>
                          ...
                          (\<forall>t. 0 \<le> t \<and> t < d \<longrightarrow> b (p t)) \<longrightarrow>
                          Q (p d) (tr @ [WaitFBlock d (\<lambda>\<tau>. State (p \<tau>)) (rdy_of_echoice cs), OutBlock ch (e (p d))])))"
           ...
           (P \<Longrightarrow>\<^sub>A
            (\<lambda>s tr.
                \<forall>d>0. \<forall>p. ODEsol ode p d \<longrightarrow>
                          p 0 = s \<longrightarrow>
                          (\<forall>t. 0 \<le> t \<and> t < d \<longrightarrow> b (p t)) \<longrightarrow>
                          (\<forall>v. Q ((p d)(var := v)) (tr @ [WaitFBlock d (\<lambda>\<tau>. State (p \<tau>)) (rdy_of_echoice cs), InBlock ch v]))))"
  ...
  proof -
    ...
    ultimately show ?thesis
      by (auto simp add: magic_wand_assn_def)
  qed
  have 4: "R (p d) (tr @ [WaitFBlock d (\<lambda>\<tau>. State (p \<tau>)) (rdy_of_echoice cs)])"
  ...
  proof -
    have "(ODErdy\<^sub>t (p 0) ode b (p d) (rdy_of_echoice cs) @- R (p d)) tr"
      using that(1) by auto
    moreover have "ODErdy\<^sub>t (p 0) ode b (p d) (rdy_of_echoice cs) [WaitFBlock d (\<lambda>\<tau>. State (p \<tau>)) (rdy_of_echoice cs)]"
...
| "d > 0 \<Longrightarrow> WaitIn\<^sub>t d p ch v rdy [WaitFBlock d (\<lambda>\<tau>. State (p \<tau>)) rdy, InBlock ch v]"
...
| "d > 0 \<Longrightarrow> WaitOut\<^sub>t d p ch e rdy [WaitFBlock d (\<lambda>\<tau>. State (p \<tau>)) rdy, OutBlock ch (e (p d))]"
