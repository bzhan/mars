...
definition Chart_A :: state where " Chart_A = State [''A'']
  ...
  (SKIP)
  (SKIP)
  [Trans (P [''A'']) (S []) (Bc True) ((print1 ''du_A'' ); (''x'' ::= Plus (V ''x'') (N 1))) (SKIP) (P [''A''])]
  [Trans (P [''A'']) (T1 (After (''tick'') (N 3))) ((V ''x'') [>=] (N 5)) (SKIP) (SKIP) (P [''B''])]
  (No_Composition)"
...
definition Chart_B :: state where " Chart_B = State [''B'']
  ...
  (SKIP)
  []
  [Trans (P [''B'']) (T1 (After (''tick'') (N 3))) (Bc True) (SKIP) (SKIP) (P [''A''])]
  (No_Composition)"
...
schematic_goal "Root_Exec_for_times env ['''', ''''] (11::int) s
 (Status (Vals ?v1 ?v2 ?v3 ?v4 ([''en_A'', ''du_A'', ''du_A'', ''du_A'', ''du_A'', ''en_B'', ''du_B'', ''du_B'', ''en_A'', ''du_A'', ''du_A''], ?o2)) (?I))"
