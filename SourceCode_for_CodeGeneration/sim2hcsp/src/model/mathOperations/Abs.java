...
public class Abs extends SL_Block {

	public Abs(String blockType, String blockName, Node node) {
	...
	public HashMap<String, String> semanticFunctionDiscrete() {
		...
		String ret1 = "(" + In1 + ">= 0" + ") -> " + Out1 + ":=" + In1;
		String ret2 = "(" + In1 + "< 0" + ") -> " + Out1 + ":= -" + In1;
